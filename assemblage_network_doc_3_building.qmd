...
For proveniences, it looks like there are quite a lot that have at least *some* similarities in their artifact content. Looking at the density of scores for each methods, it appears that the majority of proveniences have non-zero similarity scores even though there are discernible "peaks" at zero.
